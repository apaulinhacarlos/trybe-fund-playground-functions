...
Neste projeto eu implementei funções a partir de requisitos com base nos conhecimentos adquiridos durante o bloco 4 do curso de Desenvolvimento Web da Trybe.
...
```bash
git clone git@github.com:apaulinhacarlos/trybe-fund-playground-functions.git
```
